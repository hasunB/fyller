...
Route::get('/expenses/{expense}', [ExpenseController::class, 'show'])->middleware('auth')->name('expenses.show');
Route::post('/expenses/store', [ExpenseController::class, 'store'])->middleware('auth')->name('expenses.store');
